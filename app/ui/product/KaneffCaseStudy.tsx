      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <div className="rounded-2xl border border-[#E2EAF3] bg-white p-6.5">
            <h4 className="mb-4 font-mono text-[10px] font-medium tracking-[0.13em] text-[#D6412F] uppercase">
              Before
            </h4>
          ...
          <div className="rounded-2xl border border-[#E2EAF3] bg-white p-6.5">
            <h4 className="mb-4 font-mono text-[10px] font-medium tracking-[0.13em] text-[#12A67C] uppercase">
              After
            </h4>
            <ul className="list-none">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div ref={gridRef} className="mt-8.5 grid grid-cols-1 gap-5 sm:grid-cols-2">
          {TECH_GROUPS.map((group) => (
            <div key={group.title}>
              <h4 className="mb-3 font-mono text-[16px] font-medium tracking-[0.12em] text-[#2C87CC] uppercase">
                {group.title}
              </h4>
              <ul className="list-none">
...
function ConnectSection() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-[#0A0F14] px-5 py-19 text-center sm:px-8 sm:py-24 lg:py-[150px]"
    >
      <div
        aria-hidden
        className="pointer-events-none absolute bottom-[-14%] left-1/2 h-[520px] w-[min(760px,90vw)] -translate-x-1/2 rounded-full"
        style={{ background: "radial-gradient(circle, rgba(44,135,204,.2), transparent 66%)" }}
      />

      <div className="relative">
        <span className="mb-0 inline-flex items-center gap-2.5 text-[11.5px] font-bold tracking-[0.22em] text-[#2C87CC] uppercase">
          Work with us
        </span>
        ...
        >
          Let&apos;s discuss what you&apos;re building — <em className="text-[#A9B6C0] not-italic">and what&apos;s getting in the way.</em>
        </h2>
        ...
        >
          <span
            aria-hidden
            className="absolute -inset-3.5 animate-[spin_26s_linear_infinite] rounded-full border border-dashed border-white/14 transition-[border-color,opacity] duration-350 group-hover:border-[#2C87CC] group-hover:opacity-70"
          />
          <span
            aria-hidden
          ...
          />
          <span className="relative flex flex-col items-center gap-2.5 text-[16px] font-medium transition-colors duration-300 group-hover:text-[#0A0F14]">
            Let&apos;s connect
        ...
        <p className="mt-8.5 text-[14.5px] text-[#6E7C87] sm:mt-12.5">
          Or email{" "}
          <a href="mailto:info@oxytal.com" className="border-b border-white/18 pb-0.5 text-[#A9B6C0] transition-colors duration-150 hover:border-[#2C87CC] hover:text-white">
            info@oxytal.com
          </a>{" "}
