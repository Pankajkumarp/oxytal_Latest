    ...
    >
      ...
      <div className="container relative mx-auto px-5 md:px-10">
        <div ref={copyRef} className="relative z-10 max-w-full lg:max-w-[45%] xl:max-w-[42%] 2xl:max-w-[38%] pt-4 md:pt-6">
          ...
          <h1
            ref={titleRef}
            className="max-w-[680px] text-[28px] font-extrabold leading-[1.1] tracking-[-0.045em] sm:text-[34px] md:text-[40px] xl:text-[50px] mb-3 text-[#0D1B2A]"
          >
        ...
        >
          ...
          <ul className="flex flex-wrap gap-x-7 gap-y-4">
            {["Diageo", "Aviation Gin", "Casa Famosa", "Lone River", "Bundaberg Rum"].map((name) => (
              <li key={name} className="text-[0.95rem] font-semibold text-[#7d7d7e]">
                {name}
              </li>
            ))}
          </ul>
      ...
      <div className="container relative mx-auto px-5 md:px-10">
        ...
        <div ref={gridRef} className="mt-9 grid grid-cols-1 gap-x-[18px] gap-y-8 sm:grid-cols-2 lg:grid-cols-5">
          {STACK_COLUMNS.map((col) => (
            <div key={col.heading}>
              <span className="mb-3 text-[10.5px] font-medium uppercase tracking-[0.12em] text-[#1651f5] block">{col.heading}</span>
...
function EngagementSection() {
  ...
  return (
    <section className={SECTION}>
      <div className="container relative mx-auto px-5 md:px-10">
        <SectionHeading eyebrow="How we engage" title="Three ways in. All start with thinking, not a quote." headingLevel="h3" />
...
// ───────────────────────── related + final CTA ─────────────────────────
const RELATED = [
  { k: "04", title: "Cloud & Transformation", body: "The infrastructure the application runs on.", href: "/services/cloud-digital-transformation" },
  { k: "05", title: "Enterprise Integration", body: "Connecting it to everything else you run.", href: "/services/enterprise-system-integrations" },
  { k: "07", title: "AI & Agentic Engineering", body: "Automating the work the application creates.", href: "/services/ai-and-intelligent-automation" },
  { k: "02", title: "Experience Design", body: "Making sure people can actually use it.", href: "/services/ui-ux-design" },
];
...
function RelatedAndCtaSection() {
  ...
  return (
    <section className={SECTION}>
      <div className="container relative mx-auto px-5 md:px-10">
        <SectionHeading eyebrow="Related services" title="Engineering rarely travels alone." headingLevel="h4" />
